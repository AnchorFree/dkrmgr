...
require (
	...
	github.com/docker/docker v17.12.0-ce-rc1.0.20190717160951-456712c5b8d9+incompatible // indirect
	...
	go.etcd.io/etcd/raft/v3 v3.5.0-beta.4 // indirect
	...
	k8s.io/apiserver v0.18.0-alpha.1 // indirect
	k8s.io/code-generator v0.18.0-alpha.1 // indirect
